...
import com.taxitime.driverapp.R; // ✅ CRITICAL: Import R for resources
...
public class ForegroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            Intent locationIntent = new Intent(this, com.taxitime.driverapp.location.LocationTrackingService.class);
    ...
    public void onDestroy() {
        ...
        if (shouldRestartService) {
            Intent restartIntent = new Intent("com.taxitime.driverapp.RESTART_SERVICE");
